 ...
 * hold the pixels.  We can show a simple picture in a
 * PictureFrame (a JFrame).  We can also explore a simple picture.
 *
 */
public class SimplePicture implements DigitalPicture
{
     ...
     * @param flag true if we want it visible else false
     */
     ...
     * useful after we have changed the pixels in a picture and
        ...
        if (!file.canRead())
        {
            ...
            if (!file.canRead())
            {
                throw new IOException(this.fileName +
                        " could not be opened. Check that we have specified the path");
            }
        }
    ...
    public void writeOrFail(String fileName) throws IOException
    {
        ...
        if (!fileLoc.canWrite()) {
            throw new IOException(fileName +
                    " could not be opened. Check to see if we can write to the directory.");
        }
