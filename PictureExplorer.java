...
/**
 * Displays a picture and lets us explore the picture by displaying the row, column, red,
 * green, and blue values of the pixel at the cursor when we click a mouse button or
 * press and hold a mouse button while moving the cursor.  It also lets us zoom in or
 * out.  We can also type in a row and column value to see the color at that location.
 */
